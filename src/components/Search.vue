    ...
    <section class="container">
      <nav class="nav row">
        <div class=" row m-t-a-40">
          <input type="text" class="col-8" placeholder="Buscar canciones" v-model="searchQuery" @keyup.enter="search">
      ...
      <div class="col-16  m-t-40 " v-show="!isLoading">
        <ul class="row is-list-less justify-between">
          <li class="col-5" v-for="t in tracks">
            <pm-track v-blur="t.preview_url" :track="t" @select="setSelectedTrack" :class="{'is-active':t.id=== selectedTrack}"></pm-track>
          </li>
        </ul>
      </div>
